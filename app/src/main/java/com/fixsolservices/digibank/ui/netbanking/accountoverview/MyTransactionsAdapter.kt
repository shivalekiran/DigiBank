...
class MyTransactionsAdapter(private val transactions: List<MyTransaction>) :
    RecyclerView.Adapter<MyTransactionsAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(item: View) : RecyclerView.ViewHolder(item) {
        ...
        fun bindViewData(myTransaction: MyTransaction) {
